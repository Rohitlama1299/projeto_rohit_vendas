...
namespace Projeto_Rohit.pt.com.Gvendas.DAO
{
    class SQLConnection
    {
        ...
        static private readonly string sqlConnStringBdLocal = $@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename={projectDirectory}\pt.com.Gvendas.CONEXAO\Database1.mdf;Integrated Security=True";
